-----------------------------------------------------------------------------
-- Color converters for color/highglight manipulation. Source
-- copied from:
--
...
local rgb_number_to_hsl -- defined below
...
local function new(H, S, L)
   ...
   elseif type(H) == "number" and S == nil and L == nil then
      H, S, L = rgb_number_to_hsl(H)
   end
   assert(Color_mt)
...
-- already local, see at the bottom
function rgb_number_to_hsl(rgb)
    rgb = string.format('#%06x', rgb)
    return rgb_string_to_hsl(rgb)
end

M.rgb_string_to_hsl = rgb_string_to_hsl

-----------------------------------------------------------------------------
-- Converts the color to R,G,B
--
-- @return               a tuple of RGB representation of the color
-----------------------------------------------------------------------------
